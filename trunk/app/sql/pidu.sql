...
INSERT INTO `Ciclo` (`id`, `titulo`, `activo`, `etapa_actual`, `historial`) VALUES
(1, 'Ciclo 2012', 1, 'Etapa 2 - Inscripción de propuestas', 'a:3:{i:0;s:50:"2012-03-12 19:23 : Se activa el ciclo en la etapa ";i:1;s:96:"2012-03-12 19:23 : Se pasa a la siguiente etapa, antes era [], ahora es [Etapa 1 - Preparación]";i:2;s:132:"2012-03-12 19:24 : Se pasa a la siguiente etapa, antes era [Etapa 1 - Preparación], ahora es [Etapa 2 - Inscripción de propuestas]";}');
...
(1, 1, 'admin@admin.com', 'admin@admin.com', 'admin@admin.com', 'admin@admin.com', 1, '6l5u55rxmj4s8w0c4woc4kgwg004ko8', '+c9u0pgWnymbSrD/wLYp0iTtL8U=', '2012-03-10 15:52:30', 0, 0, NULL, '6l5u55rxmj4s8w0c4woc4kgwg004ko8', NULL, 'a:2:{i:0;s:10:"ROLE_ADMIN";i:1;s:16:"ROLE_SUPER_ADMIN";}', 0, NULL, '12345678', 'Admin', 'Admin', '099999', '999999', '1900'),
(2, 1, 'arieljlira@gmail.com', 'arieljlira@gmail.com', 'arieljlira@gmail.com', 'arieljlira@gmail.com', 1, 'pdht2c4153400kgogssg88s40okk8cg', 'IPFs5SPPc00OqFuFOAHjBt7mAs0=', '2012-03-03 13:01:27', 0, 0, NULL, '4p14szd2eq684gkgckc44gcowgs0cgwk4ook4ko4s8ock40gos', '2012-03-03 17:37:43', 'a:1:{i:0;s:10:"ROLE_ADMIN";}', 0, NULL, '29994156', 'lira', 'Ariel', '00099', '999', '190'),
(3, 6, 'gonetil@gmail.com', 'gonetil@gmail.com', 'gonetil@gmail.com', 'gonetil@gmail.com', 1, 'aef7p4a05dcsok04coggk0o8soo4s80', 'H959bQJT6WIfd5G2u5KEmh8LZAI=', NULL, 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:10:"ROLE_ADMIN";}', 0, NULL, '28000000', 'Gonzalo', 'Villarreal', '2222222', '222', '1900'),
(6, 5, 'docente@docente', 'docente@docente', 'docente@docente', 'docente@docente', 1, 'bwl724hp8f4gog4o8kokowswgks48kw', 'f61LkixUZIwYjNzQhOERQLI2oyY=', '2012-03-10 14:35:13', 0, 0, NULL, NULL, NULL, 'a:0:{}', 0, NULL, '2292929292', 'Perez', 'Juan Jose', '3333', '3333', '3333');

INSERT INTO `Plantilla` (`id`, `codigo`, `asunto`, `cuerpo`, `puedeBorrarse`) VALUES
(1, 'confirmar_registro_usuario', 'Confirmación de Alta de Usuario', 'Estimado {{ usuario.nombre }} {{ usuario.apellido }}\r\n      usted se ha registrado en el sistema de usuarios del "Programa Jóvenes y Memoria, recordamos para el futuro".\r\nPara completar el proceso de inscripción haga click en el siguiente link: {{url}}\r\n\r\nSaludos cordiales,\r\n\r\nEquipo Programa Jóvenes y Memoria\r\n{{url_sitio}}', 0),
(2, 'resetear_cuenta_usuario', 'Resetear clave de usuario', 'Estimado {{ usuario.nombre }} {{ usuario.apellido }}\r\n      se ha recibido una solicitud para regenerar su contraseña en el sitio web del Programa Jóvenes y Memoria {{url_sitio}}. Para cambiar su clave siga el siguiente link \r\n{{url}}\r\n\r\nSaludos cordiales,\r\n\r\nEquipo Programa Jóvenes y Memoria\r\n{{url_sitio}}', 0),
(3, 'alta_proyecto', 'Recepción de proyecto', 'Estimado {{usuario.nombre}} {{usuario.apellido}},\r\n\r\n      ¡Bienvenidos al Programa Jóvenes y Memoria, recordamos para el futuro! Hemos recibido satisfactoriamente su inscripción a la convocatoria 2012. Esperamos compartir juntos este año de trabajo.  \r\n\r\nA la brevedad, Ud. será convocado a participar de un encuentro de capacitación docente, de un día de duración, a realizarse {% if proyecto.esPrimeraVezDocente %}entre el 25 y el 27 de abril{% else %}el 10 y 11 de mayo{% endif %} próximo en la ciudad de La Plata.  \r\n\r\n\r\nSaludos cordiales,\r\n\r\nEquipo Programa Jóvenes y Memoria\r\n{{url_sitio}}', 0),
(4, 'invitacion_a_evento', '[Jóvenes y Memoria] Invitación', 'Estimado/a {{usuario.apellido}}, {{usuario.nombre}}\r\n     nos complace hacerle llegar una invitación al evento "{{invitacion.instanciaEvento.evento.titulo}}" que tendrá lugar {{invitacion.instanciaEvento.periodoComoTexto}}{% if invitacion.instanciaEvento.lugar %} en {{invitacion.instanciaEvento.lugar }}{% endif%}.\r\n\r\n{{invitacion.instanciaEvento.evento.descripcion}}\r\n{{invitacion.instanciaEvento.descripcion}}\r\n\r\nEsperamos contar con su valiosa participación por cuanto agradeceremos confirmar su asistencia, o en su defecto indicar que no asistirá, vistando la siguiente dirección web: {{url}}  antes del día {{invitacion.instanciaEvento.fechaCierreInscripcion|date(''d/m'')}}. \r\n\r\nSaludos cordiales,\r\n\r\nEquipo Programa Jóvenes y Memoria\r\n{{url_sitio}}', 0),
(5, 'comunicacion_usuario', '[Jóvenes y memoria] Comunicación', 'Estimado/a {{usuario.apellido}}, {{usuario.nombre}}\r\n     ...escriba aqui el cuerpo de su comunicación....\r\n\r\nSaludos cordiales,\r\n\r\nEquipo Programa Jóvenes y Memoria\r\n{{url_sitio}}', 0),
(6, 'invitacion_a_evento_a_escuela', '[Jóvenes y memoria] Invitación', '{{ proyecto.escuela }} \r\n Estimado/a \r\n el equipo del Programa Jóvenes y Memoria desea hacerle llegar a su institución la invitación al evento "{{invitacion.instanciaEvento.evento.titulo}}" que tendrá lugar {{invitacion.instanciaEvento.periodoComoTexto}}{% if invitacion.instanciaEvento.lugar %} en {{invitacion.instanciaEvento.lugar }}{% endif%}. \r\n\r\n
{{invitacion.instanciaEvento.evento.descripcion}}\r\n{{invitacion.instanciaEvento.descripcion}}\r\n\r\n Esta notificación se le ha enviado también a {{proyecto.coordinador.nombre}} {{proyecto.coordinador.apellido}}, quien participa como coordinador del proyecto. Es importante que el coordinador nos confirme su asistencia, o en su defecto nos informe que no asistirá, antes del día {{invitacion.instanciaEvento.fechaCierreInscripcion|date("d/m")}}. \r\n Saludos cordiales,\r\n\r\n Equipo Programa Jóvenes y Memoria \r\n{{url_sitio}}', 0),
(7, 'invitacion_a_evento_a_colaboradores', '[Jóvenes y memoria] Invitación', 'Estimado/a {{usuario.apellido}} {{usuario.nombre}}\r\n  nos complace hacerle llegar una invitación al evento "{{invitacion.instanciaEvento.evento.titulo}}" que tendrá lugar {{invitacion.instanciaEvento.periodoComoTexto}}{% if invitacion.instanciaEvento.lugar %} en {{invitacion.instanciaEvento.lugar }}{% endif%}.\r\n\r\n{{invitacion.instanciaEvento.evento.descripcion}}\r\n{{invitacion.instanciaEvento.descripcion}} \r\n Esta notificación se le ha enviado también a {{proyecto.coordinador.nombre}} {{proyecto.coordinador.apellido}}, quien participa como coordinador del proyecto. Es importante que el coordinador nos confirme su asistencia, o en su defecto nos informe que no asistirá, antes del día {{invitacion.instanciaEvento.fechaCierreInscripcion|date("d/m")}}. \r\n Saludos cordiales,\r\n\r\n Equipo Programa Jóvenes y Memoria \r\n{{url_sitio}}', 0);



INSERT INTO `Etapa` (`id`, `nombre`, `descripcion`, `numero`, `proyectos_vigentes_action`, `deprecated`, `acciones_de_usuario`, `acciones_de_proyecto`) VALUES
(1, 'Etapa 1 - Preparación', 'Etapa previa al comienzo del ciclo. Ideal para registrar eventos, agregar localidades, distritos y regiones, verificar el listado de temas, tipos de instituciones y tipos de escuelas, etc.', 1, 'proyecto', 0, 'a:0:{}', 'a:0:{}'),
(2, 'Etapa 2 - Inscripción de propuestas', 'En la etapa 2, los docentes pueden registrarse como usuarios, y agregar sus propuestas de proyectos', 2, 'proyecto', 0, 'a:1:{i:0;s:15:"cargar_proyecto";}', 'a:1:{i:1;s:15:"editar_proyecto";}'),
(3, 'Etapa 3 - Revisión de propuestas', 'Durante la tercer etapa, los administradores revisan las propuestas enviadas por los docentes, y también organizan la primer capacitación. El registro de propuestas permanece cerrado.', 3, 'proyecto', 0, 'N;', 'N;'),
(4, 'Etapa 4 - Desarrollo de proyectos', 'Durante la cuarta etapa, los docentes deben adjuntar los proyectos completos y confirmar ciertos datos de su propuesta original.', 4, 'proyecto', 0, 'a:0:{}', 'a:3:{i:0;s:18:"presentar_proyecto";i:1;s:23:"modificar_colaboradores";i:2;s:20:"representar_proyecto";}'),
(5, 'Etapa 5 - Reenvio de proyectos rehacer', 'En esta etapa los docentes cuyas propuestas no han sido aprobadas tendrán la oportunidad de reenviarlas. Los administradores podrán también cargar aquí las evaluaciones de estas propuestas', 5, 'proyecto', 0, 'a:0:{}', 'a:1:{i:0;s:23:"modificar_colaboradores";}'),
(6, 'Etapa 6 - Presentación de proyectos', 'En la sexta etapa, los docentes que posean sus propuestas aprobadas podrán cargar los proyectos completos como archivos adjuntos. Al cargarlos, se les solicita que confirmen algunos datos como título del proyecto, tema, producción final y descripción breve.', 6, 'proyectos_presentados', 0, 'a:0:{}', 'a:0:{}'),
(7, 'Etapa 7 - Preparación para Chapadmalal', 'Durante esta etapa los administradores organizan el encuentro en Chapadmalal, cargando las distintas instancias, enviando las invitaciones a los docentes, coordinando los viajes de las escuelas (pasajes, medios de transporte...), etcétera', 8, 'proyectos_aprobados', 0, 'a:0:{}', 'a:0:{}'),
(8, 'Etapa 8 - Durante Chapadmalal', 'Esta etapa permanece abierta mientras se está realizando el encuentro de Chapadmalal', 7, 'proyectos_aprobados', 0, 'a:0:{}', 'a:0:{}'),
(9, 'Etapa 9 - Etapa final', 'Una vez finalizado el encuentro en Chapadmalal, los administradores podrán cargar observaciones sobre los proyectos y presentaciones, agregar información faltante, y finalmente cerrar el ciclo actual', 9, 'proyectos_aprobados', 0, 'a:0:{}', 'a:0:{}');
