/**
 * Extension de la directiva select que permite matchear objetos de select con ng-options y modelos.
 * Taken from https://github.com/configit/ngyn/blob/master/src/select-key/select-key.js
 */
( function( angular ) {
  'use strict';
