    ...
    public function buildForm(FormBuilder $builder, array $options)
    {
        ...
        $builder
         //   ->add('ciclo')
            ...
            ->add('solicitarArchivoAdjunto','choice',array('label' => '¿Solicitar que se adjunte un archivo?', 'expanded'=>true, 'choices' => array(1=>"si",0=>"no"), 'attr'=>array('class'=>'inline hidden')))
            ->add('descripcionArchivoAdjunto',null,array('label'=>'Descripción del campo de archivo adjunto', 'attr'=>array('class'=>'hidden')))
